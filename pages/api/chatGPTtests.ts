...
const int_question = 'What excites or interests you about coding?'
const int_answer =
...
const runPrompt = async () => {
  ...
  //       {
  //         role: 'system',
  //         content: `You are a recruiter working at a tech company conducting and interview and you ask the following question: ${int_question}. Respond to the answer in a way that would be appropriate for a recruiter to continue the conversation.`,
  //       },
